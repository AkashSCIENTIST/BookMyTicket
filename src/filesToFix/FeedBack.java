...
FeedBack(){    
super("Feedback Form");     
Icon _1s = new ImageIcon("D:\\project_pics\\worst.jpeg");
rb1=new JRadioButton(_1s);    
//rb1.setPreferredSize(new Dimension(50,50));
Icon _2s = new ImageIcon("D:\\project_pics\\bad.JPEG");   
rb2=new JRadioButton(_2s);    
Icon _3s = new ImageIcon("D:\\project_pics\\meh.jpeg");
rb3=new JRadioButton(_3s);    
Icon _4s = new ImageIcon("D:\\project_pics\\nice.jpeg");
rb4=new JRadioButton(_4s);    
Icon _5s = new ImageIcon("D:\\project_pics\\amazing.jpeg");
...
panel.setBackground(new Color(245, 223, 223));
